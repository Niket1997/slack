...
public class MessageController {
  ...
  public Message updateMessage(
      @PathVariable Integer messageId, @RequestBody UpdateMessageRequest request) {
  ...
  @GetMapping("")
  public List<Message> getMessagesInChannelFromUser(
      @RequestParam(name = "channelId") Integer channelId,
      @RequestParam(name = "senderUserId") Integer senderUserId) {
